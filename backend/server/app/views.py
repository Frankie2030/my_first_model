...
def deactivate_other_statuses(instance):
    old_statuses = MLModelStatus.objects.filter(parent_mlalgorithm=instance.parent_mlalgorithm,
    ...
    def perform_create(self, serializer):
        try:
            with transaction.atomic():
                ...
                status_1 = MLModelStatus(status = "ab_testing",
                ...
                status_2 = MLModelStatus(status = "ab_testing",
                                created_by=instance.created_by,
